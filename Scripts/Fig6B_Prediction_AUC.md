...
# Plot the AUC (with y-axis from 0.5)
barCenters <- barplot(Result[,2]-0.5, names=Result[,1], las=2, main="Area under the curve", col=Result[,"Color"], ylim=c(0,0.30), yaxt="n")
axis(2, at = seq(0, 0.3, by=0.05) ,labels = seq(0.5,0.8,by=0.05), las=1)
arrows(barCenters,Result$AUC_lower-0.5,barCenters,Result$AUC_upper-0.5, lwd = 1.5, angle = 90,code = 3, length = 0.05)
abline(h=0.1,lty=2)
box()
```
