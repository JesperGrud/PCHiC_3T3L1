...
par(mfcol=c(1,3))
Gene <- FilteredInteractions_Genes[ FilteredInteractions_Genes$Symbol == "Maged2",]
...
circos.trackPlotRegion("A", ylim=c(0,10), track.height=0.2, bg.border="white") 
circos.lines(c(-180,180), c(0,0), lty=2, lwd=1)
circos.lines(c(-180,180), c(10,10), lty=2, lwd=1)
...
circos.par(gap.degree=0, start.degree=-90)
circos.initialize("A", xlim=c(-179,179))
circos.trackPlotRegion("A", ylim=c(0,30), track.height=0.2, bg.border="white") 
circos.lines(c(-180,180), c(0,0), lty=2, lwd=1)
circos.lines(c(-180,180), c(30,30), lty=2, lwd=1)
for (i in 1:18) { circos.rect(Histogram[i,1], Histogram[i,2], Histogram[i,3],Histogram[i,4], col="grey") } 
circos.trackPlotRegion("A", ylim=c(0,4), track.height=0.5, bg.border="white") 
circos.points(Gene$H, abs(Gene$logFC_max), col = Gene$color, pch=20) 
circos.lines(c(-180,180), c(0,0), lty=2, lwd=1)
...
# Define the gene to test
Gene <- FilteredInteractions_Genes[ FilteredInteractions_Genes$Symbol == "Pparg",]
Gene[ abs(Gene$logFC_max) > 4, "logFC_max"] <- 4
...
circos.par(gap.degree=0, start.degree=-90)
circos.initialize("A", xlim=c(-179,179))
circos.trackPlotRegion("A", ylim=c(0,50), track.height=0.2, bg.border="white") 
circos.lines(c(-180,180), c(0,0), lty=2, lwd=1)
circos.lines(c(-180,180), c(50,50), lty=2, lwd=1)
for (i in 1:18) { circos.rect(Histogram[i,1], Histogram[i,2], Histogram[i,3],Histogram[i,4], col="grey") } 
circos.trackPlotRegion("A", ylim=c(0,4), track.height=0.5, bg.border="white") 
circos.points(Gene$H, abs(Gene$logFC_max), col = Gene$color, pch=20) 
circos.lines(c(-180,180), c(0,0), lty=2, lwd=1)
