...
Gene <- FilteredInteractions_Genes[ FilteredInteractions_Genes$Symbol == "Fabp4",]
...
circos.trackPlotRegion("A", ylim=c(0,15), track.height=0.2, bg.border="white") 
circos.lines(c(-180,180), c(0,0), lty=2, lwd=1)
circos.lines(c(-180,180), c(15,15), lty=2, lwd=1)
